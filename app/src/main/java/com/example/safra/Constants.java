...
public class Constants {
    ...
    public static final String HTTP_AUTHORIZATION_VALUE_PREFIX_upper = "Bearer %s";


    // Open Banking
    private static final String BASE_OPEN_BANKING_ENDPOINT = "open-banking/v1/accounts";
    ...
    // Movements
    private static final String BASE_MOVEMENTS_ENDPOINT = "accounts/v1/accounts";
    public static final String TRANSFER_ENDPOINT = BASE_MOVEMENTS_ENDPOINT + "/{accountId}" + "/transfer";

    // Calls
    private static final String BASE_CALL_ENDPOINT = "media/v1/youtube";

    // OPEN ACCOUNT
    private static final String BASE_OPEN_ACCOUNT_ENDPOINT = "accounts/v1/youtube";
